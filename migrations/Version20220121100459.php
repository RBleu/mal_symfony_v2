 ...
 */
final class Version20220121100459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ms_user_list (ul_user_id INT NOT NULL, ul_anime_id INT NOT NULL, ul_list_type_id INT NOT NULL, ul_priority_id INT NOT NULL, ul_score INT NOT NULL, ul_comment LONGTEXT DEFAULT NULL, ul_modification_date DATETIME NOT NULL, ul_progress_episodes INT NOT NULL, INDEX IDX_3E49B4D1A76ED395 (ul_user_id), INDEX IDX_3E49B4D1794BBE89 (ul_anime_id), INDEX IDX_3E49B4D11903519E (ul_list_type_id), INDEX IDX_3E49B4D1497B19F9 (ul_priority_id), PRIMARY KEY(ul_user_id, ul_anime_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE ms_user_list ADD CONSTRAINT FK_3E49B4D1A76ED395 FOREIGN KEY (ul_user_id) REFERENCES ms_user (u_id)');
        $this->addSql('ALTER TABLE ms_user_list ADD CONSTRAINT FK_3E49B4D1794BBE89 FOREIGN KEY (ul_anime_id) REFERENCES ms_anime (a_id)');
        $this->addSql('ALTER TABLE ms_user_list ADD CONSTRAINT FK_3E49B4D11903519E FOREIGN KEY (ul_list_type_id) REFERENCES ms_list_type (lt_id)');
        $this->addSql('ALTER TABLE ms_user_list ADD CONSTRAINT FK_3E49B4D1497B19F9 FOREIGN KEY (ul_priority_id) REFERENCES ms_priority (p_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_list DROP FOREIGN KEY FK_3E49B4D1794BBE89');
        $this->addSql('ALTER TABLE anime_genre DROP FOREIGN KEY FK_EFF953C74296D31F');
        $this->addSql('ALTER TABLE user_list DROP FOREIGN KEY FK_3E49B4D11903519E');
        $this->addSql('ALTER TABLE user_list DROP FOREIGN KEY FK_3E49B4D1497B19F9');
        ...
        $this->addSql('CREATE TABLE ms_anime_genre (ag_anime_id INT NOT NULL, ag_genre_id INT NOT NULL, INDEX IDX_EFF953C7794BBE89 (ag_anime_id), INDEX IDX_EFF953C74296D31F (ag_genre_id), PRIMARY KEY(ag_anime_id, ag_genre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE ms_anime_relation (ar_prequel_id INT NOT NULL, ar_sequel_id INT NOT NULL, INDEX IDX_7FAD397DE980FB2E (ar_prequel_id), INDEX IDX_7FAD397DF065ABA1 (ar_sequel_id), PRIMARY KEY(ar_prequel_id, ar_sequel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE ms_list_type (lt_id INT AUTO_INCREMENT NOT NULL, lt_name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, lt_list_key VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(lt_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE ms_priority (p_id INT AUTO_INCREMENT NOT NULL, p_name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(p_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE ms_theme (th_id INT AUTO_INCREMENT NOT NULL, th_anime_id INT NOT NULL, th_name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, th_type VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_9775E708794BBE89 (th_anime_id), PRIMARY KEY(th_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
